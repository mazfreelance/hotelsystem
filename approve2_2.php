...
if (!empty($_POST['sub'])) {
	...
	$sql = "UPDATE room SET room_type='$roomtype' , room_num='$available',price ='$price' WHERE room_id=$available2";
	

	if (($mysqli_db->query($sql) == TRUE)) {
  	  echo "<script>alert('Record updated successfully!')</script>";
	  
	  echo "<script>window.open('addbook_2.php','_self')</script>";
	} else {
