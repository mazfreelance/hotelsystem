...
<div id="wrapper">
    ...
    <form method="post" action="approve2_2.php">
    ...
    <tr>
        ...
        <td><input type="text" id="aroom" size="12" name="ic" value="<?php echo " $roomno "; ?>"/></td>
    </tr>
    <input type="hidden" size="12" name="ic2" value="<?php echo " $ic "; ?>"/>
    <tr>
    	<td>Price:</td>
        <td><input type="text" id="roomprice" size="12" name="name" value="<?php echo " $price "; ?>"/></td>
    </tr>
    </table>
    </fieldset>
    <br><br>
